...
type CerberusInstitutionAccounts struct{}

func (t *CerberusInstitutionAccounts) Init(stub shim.ChaincodeStubInterface) pb.Response {
...
func (t *CerberusInstitutionAccounts) Invoke(stub shim.ChaincodeStubInterface) pb.Response {
...
func main() {
	...
	err := shim.Start(new(CerberusInstitutionAccounts))

	if err != nil {
		fmt.Println("Error starting Institution chaincode: %s", err.Error())
	}
}
