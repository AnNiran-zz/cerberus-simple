...
func (t *CerberusPersonAccounts) createAccount(stub shim.ChaincodeStubInterface, args []string) pb.Response {
	...
	personAccountAsBytes, err := json.Marshal(newAccount)
	...
	err = stub.PutState(newAccount.PublicId, personAccountAsBytes)
	...
	return shim.Success(personAccountAsBytes)
}
